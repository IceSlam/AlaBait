...
<head>
  ...
  <?php wp_head(); ?>
  <meta name="yandex-verification" content="9ddae1e95d2565a8" />
...
<noscript><div><img src="https://mc.yandex.ru/watch/69593938" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</head>
          ...
          <div class="container">
            ...
            <div id="sb-search" class="sb-search">
              <form role="search" method="get" id="searchform" action="<?php echo home_url( '/' ) ?>" >
                <input class="sb-search-input" type="text" value="<?php echo get_search_query() ?>" name="s" id="s" >
