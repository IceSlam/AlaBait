...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'alabait' ); ?></a>
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$alabait_description = get_bloginfo( 'description', 'display' );
			if ( $alabait_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $alabait_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
<!--
