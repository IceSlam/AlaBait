      ...
      <div class="is-cases__main-negative container">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6 is-cases__main-cardn">
            <div class="card card-image" style="background-image: url(./assets/alabayt/img/cases_cardn-item.jpg);">
              <div class="is-cases__main-cardn-mask">
                <div class="text-white d-flex align-items-center">
                  <div class="is-cases__main-cardn-content">
                    <h5 class="pink-text">32.12.2029</h5>
                    <h3 class="card-title"><a href="!#">Переход с 1С Торговля и склад 7.7
                      на Управление торговлей 11.4</a></h3>
                    <p>К нам обратился клиент с просьбой внедрения CRM-системы. Вводные данные: клиент занимается продажей оборудования через различные площадки в интернете, плюс есть свой лендинг, также планируется свой полноценный интернет-магазин..</p>
                  </div>
                </div>
              </div>
            </div>
