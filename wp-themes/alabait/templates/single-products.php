...
<div style="position:relative;" class="is-cases__navs container">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <a href="!#" style="margin-bottom: -2.9em;" class="btn is-details__header__btn-buy"  uk-toggle="target: #order-buy">
            <span class="mx-auto">
              Заказать услугу
            </span>
            <span class="ml-auto">
        ...
        <div class="col-md-6">
          <a style="margin-top:1em;" class="is-video__fancy-video" data-fancybox href="<? echo get_field('products_item_video'); ?>&amp;autoplay=1&amp;rel=0&amp;controls=0&amp;showinfo=0">
